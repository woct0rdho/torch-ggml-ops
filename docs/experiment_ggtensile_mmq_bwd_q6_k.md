...
The compact-N pipeline is a measured timing rejection. Its temporary code is removed after preserving artifacts under `/home/wd/tmp/torch-ggml-ops/ggtensile-q6-compact-m64-pipeline/`; the selected catalog remains authoritative. A complete recursive review still follows as a separate iteration and cannot reuse this measurement iteration as the final stopping pass.
