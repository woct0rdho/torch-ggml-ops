...
Before declaring the Q4_K grouped campaign complete, reread this record, `docs/ggtensile_plan.md`, `docs/experiment_hip_grouped_mmq_fwd_q4_k.md`, the ordinary Q4_K forward record, grouped HIP source and normalized ISA, the TensileLite grouped writer and current grouped test configurations, relevant Composable Kernel fixed-NK scheduling code, every generated grouped artifact and timing report, rejected candidates, target ISA material, and relevant forward and backward mechanisms.
