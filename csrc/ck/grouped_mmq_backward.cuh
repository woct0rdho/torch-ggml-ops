...
static inline void launch_grouped_mmq_grad_input(
    ...
    if constexpr (type == GGML_TYPE_IQ2_S) {
        if (out_features == GROUPED_BACKWARD_TILED_IQ2_DOWN_OUT_FEATURES &&
            in_features == GROUPED_BACKWARD_TILED_IQ2_DOWN_IN_FEATURES) {
            if (rows >= num_groups * GROUPED_BACKWARD_TILED_M) {
                launch_grouped_mmq_grad_input_iq2_tiled<false>(
                    grad_output,
                    packed_weight,
                    grad_input,
                    expert_indices,
                ...
                launch_grouped_mmq_grad_input_iq2_s2(
                    grad_output,
                    packed_weight,
                    grad_input,
                    expert_indices,
                ...
                launch_grouped_mmq_grad_input_iq2_tiled<true>(
                    grad_output,
                    packed_weight,
                    grad_input,
                    expert_indices,
...
static inline void launch_grouped_mmq_pair_grad_input(
    ...
    if constexpr (type == GGML_TYPE_Q3_K) {
        if (out_features == GROUPED_BACKWARD_TILED_Q3_OUT_FEATURES &&
            ...
            if (rows >= num_groups * GROUPED_BACKWARD_TILED_M) {
                launch_grouped_mmq_pair_grad_input_q3_n64_large(
                    first_grad_output,
                    second_grad_output,
                    first_packed_weight,
    ...
    if constexpr (type == GGML_TYPE_IQ2_S) {
        if (out_features == GROUPED_BACKWARD_TILED_IQ2_PAIR_OUT_FEATURES &&
            ...
            if (rows >= num_groups * GROUPED_BACKWARD_TILED_M) {
                ...
                launch_grouped_mmq_pair_grad_input_iq2_tiled<true>(
                    first_grad_output,
                    second_grad_output,
                    first_packed_weight,
                    second_packed_weight,
